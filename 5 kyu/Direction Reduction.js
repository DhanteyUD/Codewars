...
// but they become directly opposite after the reduction of "EAST" and "WEST" so the whole path is reducible to
// ["WEST", "WEST"].
...
function dirReduc(arr) {
  arr = arr.join('');
  let cardinal = /NORTHSOUTH|EASTWEST|WESTEAST|SOUTHNORTH/;
  while (cardinal.test(arr)) arr = arr.replace(cardinal, '');
  return arr.match(/NORTH|EAST|WEST|SOUTH/g) || [];
}
