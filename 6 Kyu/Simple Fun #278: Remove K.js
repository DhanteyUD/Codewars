...
// Given a number k, find the smallest integer n such that if any k elements are removed from the set {1, 2, ..., n}, 
// one can still find k distinct numbers among the remaining elements with sum of n.
...
// Why isn't the result 6? Because: In set {1, 2, 3, 4, 5, 6}, 
// if we remove 2 elements (1,2), or (4,5) the remaining elements 
